    ...
    <div className="p-4 sm:p-6 bg-gray-900">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <a
          ...
          className="text-red-500 md:mr-4 md:text-lg  hover:text-red-400 text-xs sm:text-sm font-semibold underline-none transition-colors duration-300"
        >
          See More
        </a>
      </div>
...
const Posters = () => {
  ...
  const handleseemore = (title)=>{
   navigate("/seemore", { state: { title, items: movies } });
  }

  return (
    <div>
      <Slider title="Featured Posters" items={movies} onSeeMore={handleseemore} />
      <Slider title="Pamphlets" items={movies} onSeeMore={handleseemore} />
      <Slider title="Brochures" items={movies} onSeeMore={handleseemore} />
    </div>
  );
};
